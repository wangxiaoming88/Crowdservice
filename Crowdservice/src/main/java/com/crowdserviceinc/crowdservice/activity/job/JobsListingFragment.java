...
import com.crowdserviceinc.crowdservice.adapter.JobListingAdapter;
...
public class JobsListingFragment extends Fragment implements OnClickListener,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		JSONObject provideServiceEvent = new JSONObject();

		String userId = Constants.uid;
		String userName = Constants.username;

		try {
			provideServiceEvent.put("User", userName);
			provideServiceEvent.put("UserId", userId);
			mixpanel.track("ProvideServiceEvent", provideServiceEvent);
