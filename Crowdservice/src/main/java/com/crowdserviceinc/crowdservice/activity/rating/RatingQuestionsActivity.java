...
public class RatingQuestionsActivity extends ParentActivity implements OnClickListener {

	private TextView question = null, question2 = null;
	private RadioButton yesRadio = null, noRadio = null, yesRadio2 = null,
			noRadio2 = null; 
	private Button feedback_answer_done;
	...
	private void iniUi() {
		...
		yesRadio = (RadioButton) findViewById(R.id.btnYes1);
		noRadio = (RadioButton) findViewById(R.id.btnNo1);
		yesRadio2 = (RadioButton) findViewById(R.id.btnYes2);
		noRadio2 = (RadioButton) findViewById(R.id.btnNo2);

		yesRadio.setOnClickListener(this);
		noRadio.setOnClickListener(this);
		yesRadio2.setOnClickListener(this);
		noRadio2.setOnClickListener(this);
