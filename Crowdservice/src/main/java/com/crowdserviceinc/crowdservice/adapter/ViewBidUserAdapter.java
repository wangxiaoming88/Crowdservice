...
import com.crowdserviceinc.crowdservice.activity.job.JobAndCourierDetailBaseFragment;
...
//			holder.ratingBar.setIsIndicator(false);
			...
			holder.star1_j = (ImageView) ll.findViewById(R.id.rating_star1);
			holder.star2_j = (ImageView) ll.findViewById(R.id.rating_star2);
			holder.star3_j = (ImageView) ll.findViewById(R.id.rating_star3);
			holder.star4_j = (ImageView) ll.findViewById(R.id.rating_star4);
			holder.star5_j = (ImageView) ll.findViewById(R.id.rating_star5);
			
			holder.imgShield = (ImageView) ll.findViewById(R.id.imgShield);
			holder.imgMapMarker = (ImageView) ll.findViewById(R.id.imgMapMarker);
	...
	private class Holder {
		...
		public ImageView nextArrow, star1_j, star2_j, star3_j, star4_j, star5_j, imgShield, imgMapMarker;
		public RelativeLayout container;
		public Button accept;
	}

	private void showRating(Holder holder, double rate){
		if (rate > 4.0){
